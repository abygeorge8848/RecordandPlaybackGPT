...
equals_variable1_value_entry.insert(0, 'Enter variable name')
...
equals_variable2_value_entry.insert(0, 'Enter value')
...
not_equals_variable1_value_entry.insert(0, 'Enter variable name')
...
not_equals_variable2_value_entry.insert(0, 'Enter value')
...
num_equals_variable1_value_entry.insert(0, 'Enter variable name')
...
num_equals_variable2_value_entry.insert(0, 'Enter value')
...
num_not_equals_variable1_value_entry.insert(0, 'Enter variable name')
...
num_not_equals_variable2_value_entry.insert(0, 'Enter value')
